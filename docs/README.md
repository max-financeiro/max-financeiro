# Documentação — Sistema Financeiro Maxfem

Documentos vivos. Atualizados conforme o projeto evolui.
...
- Toda mudança nestes docs vai via PR — escritos por humano ou Claude, revisado pelo outro
- Decisões de arquitetura ficam aqui (não em commits soltos)
- Quando algo muda, atualizar o doc no mesmo PR — código e doc nunca devem divergir

## Fontes originais

Os documentos PRD, Architecture e Security foram preservados a partir dos drafts originais
da Maxfem (Maio 2026). Os arquivos `.md` desta pasta são a fonte da verdade daqui pra frente.
