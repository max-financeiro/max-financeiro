-- ============================================================
-- 20260516000014_update_supplier_bank_details_rpc_nullable_args.sql
-- ------------------------------------------------------------
-- Redefine a RPC com DEFAULT NULL nos params opcionais.
-- Sem isso, o gerador de tipos TS marca todos como `string` (não-nullable).
-- ============================================================

-- Postgres não permite REPLACE de função quando muda assinatura/defaults,
-- então recriar do zero.
DROP FUNCTION IF EXISTS public.update_supplier_bank_details(
  UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, INET, TEXT
);
...
CREATE OR REPLACE FUNCTION public.update_supplier_bank_details(
  ...
  p_account_holder_doc  TEXT DEFAULT NULL,
